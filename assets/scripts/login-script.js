...
/**
 *Membuat variabel expectPassword untuk menyimpan informasi password sementara.
 *@constant {string}
 */
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Namun jika tidak sesuai maka menampilkan informasi bahwa input salah. */
    showPopUp();
  }
});
